/************************************************************************
	 ...
	 Comment:
						...
						the widgets, including the "WaterView" which has the
	...
	//========================================================================
{
	...
	begin();	// add to this widget
	{
		...
		waterView = new WaterView(5, 5, 590, 590);
		waterView->tw = this;
		waterView->m_pTrack = &m_Track;
		this->resizable(waterView);
		...
		// Light
		pty += 25;
		lightDistanceScale = new Fl_Value_Slider(655, pty, 140, 20, "lightDistanceScale");
		lightDistanceScale->range(0, 10);
		lightDistanceScale->value(2.83);
		lightDistanceScale->align(FL_ALIGN_LEFT);
		lightDistanceScale->type(FL_HORIZONTAL);
		pty += 25;
		lightPower = new Fl_Value_Slider(655, pty, 140, 20, "lightPower");
		lightPower->range(0, 10);
		lightPower->value(5.87);
		lightPower->align(FL_ALIGN_LEFT);
		lightPower->type(FL_HORIZONTAL);
		pty += 25;
		ambientLight = new Fl_Value_Slider(655, pty, 140, 20, "ambientLight");
		ambientLight->range(0, 1.0);
		ambientLight->value(1);
		ambientLight->align(FL_ALIGN_LEFT);
		ambientLight->type(FL_HORIZONTAL);
		pty += 25;
		specularLight = new Fl_Value_Slider(655, pty, 140, 20, "specularLight");
		specularLight->range(0, 1.0);
		specularLight->value(0.02f);
		specularLight->align(FL_ALIGN_LEFT);
		specularLight->type(FL_HORIZONTAL);
